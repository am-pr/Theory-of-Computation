...
const SideBar = () => {
  ...
  return (
    <nav className='hidden md:flex h-full w-60 justify-center items-center fixed bg-slate-500 opacity-80 right-9'>
      <section className='grow'>
        <div
          onClick={() => setIsToolsOpen(!isToolsOpen)}
          className={`${
            isToolsOpen ? "bg-darkMediumColor" : ""
          } bg-darkColor cursor-pointer shadow hover:shadow-2xl transition-all w-full h-28 rounded-xl flex justify-center items-center`}
        >
        ...
        <div
          ...
          } mt-9 cursor-pointer hover:shadow-2xl transition-all w-full h-28 rounded-xl flex justify-center items-center`}
        >
          <span className='text-center text-primaryColor text-2xl font-bold'>
            عملگـــرها
          </span>
