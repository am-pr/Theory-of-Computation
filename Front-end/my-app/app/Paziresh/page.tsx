      ...
      <MachineInfo redirectPathname='/Paziresh/result' />
        ...
        <main className="md:hidden">
          ...
          <header className=" h-[8.75rem] w-full bg-darkColor flex justify-between">
            ...
            <h1 className="text-xl font-black text-primaryColor mr-[1.75rem] mt-[3.625rem]">پذیرش رشته</h1>
          </header>
          {/* End: header */}
          ...
          <div>
            ...
            <span className="font-bold text-sm  flex justify-end mr-4 mt-6">گام اول</span>
